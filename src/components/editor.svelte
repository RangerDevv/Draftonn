...
<div class=" flex flex-row justify-center items-center gap-8 p-2 truncate">
<input type="text" bind:value={LoadedTitle} placeholder="Title" class="border-none text-4xl font-bold text-center bg-transparent active:border-none mx-auto self-center h-16 text-ellipsis"/>
